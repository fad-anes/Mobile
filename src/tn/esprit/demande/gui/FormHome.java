...
public class FormHome extends Form {
    ...
    public FormHome(Form previous) {
        ...
        getToolbar().addMaterialCommandToRightBar("", FontImage.MATERIAL_LOGOUT, ev -> { new Client().show();});
       ...
       ImageViewer tunitask = new ImageViewer(MyApplication.theme.getImage("logo.png"));
