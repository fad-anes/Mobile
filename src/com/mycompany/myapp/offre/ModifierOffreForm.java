...
public class ModifierOffreForm extends BaseForm {
    ...
    Form current;
    public ModifierOffreForm(Resources res, int idoffre ) {
      
        
        Offre Offre =new Offre();
         Offre = ServiceOffre.getInstance().recupererOffre(idoffre);
            ...
            try {
                ...
                if(titre.getText().equals("") || description.getText().equals("")|| salaireh.getText().equals("")) {
                   ...
                   Offre c = new Offre(
                    ...
                    ServiceOffre.getInstance().modifierOffre(c,idoffre);
