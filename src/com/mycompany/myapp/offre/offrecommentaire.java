 ...
 * @author anes_
 */
public class offrecommentaire extends BaseForm{
    Form current; 
public offrecommentaire(Resources res ) {
...
viewMyOffersBtn.setText("Voirs les Commentaires");
...
viewMyOffersBtn.addActionListener((e) -> {
    ...
    voirscommentaires a = new voirscommentaires(res,com.getIdoffre());
    a.show();
    refreshTheme();
});
