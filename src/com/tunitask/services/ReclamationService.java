...
public class ReclamationService {
    ...
    public int add(Reclamation reclamation,int id) {
        ...
        cr.setUrl(Statics.BASE_URL + "/reclamation/addreclamation/"+id);
    ...
    public int edit(Reclamation reclamation,int id) {
        ...
        cr = new ConnectionRequest();
        cr.setHttpMethod("POST");
        cr.setUrl(Statics.BASE_URL + "/reclamation/modreclamation/"+id);
    ...
    public int delete(int reclamationId) {
        cr = new ConnectionRequest();
        cr.setUrl(Statics.BASE_URL + "/reclamation/deletereclamation/"+reclamationId);
        cr.setHttpMethod("POST");
