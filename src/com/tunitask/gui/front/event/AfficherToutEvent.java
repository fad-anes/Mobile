...
public class AfficherToutEvent extends Form {
    ...
    private Container makeModelWithoutButtons(Event event) {
        ...
        if (event.getImage() != null) {
            ...
            Image image = URLImage.createToStorage(EncodedImage.createFromImage(theme.getImage("default.jpg").fill(1100, 500), false), url, url, URLImage.RESIZE_SCALE);
